...
/**
 * @title ERC721AutoIncrementMintStorage
 */
library ERC721AutoIncrementMintStorage {
    ...
    bytes32 internal constant STORAGE_SLOT = keccak256("layered.contracts.storage.ERC721AutoIncrementMint");
